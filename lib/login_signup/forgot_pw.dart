...
import 'package:wallet/login_signup/check_email.dart';
import 'package:flutter_svg/flutter_svg.dart';
class FP extends StatefulWidget {
  FP({Key? key }) : super(key: key);
          ...
          child: Stack(
            children: [
              ...
              Column(
                children:<Widget> [
                  Center(
                    child: Text('Enter your registrated email address to receive',
                      style: TextStyle(fontSize: 14,color: Color.fromRGBO(72, 80, 104, 1)),),
                  ),
                  Center(
                    child: Text('password reset instruction',
                      style: TextStyle(fontSize: 14,color: Color.fromRGBO(72, 80, 104, 1)),),
                  ),
                ],
              )),
